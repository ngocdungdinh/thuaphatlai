...
class BlogController extends BaseController {
    ...
    public function getCategory($catSlug)
    {
        ...
        //Paginator::setViewName('pagination::simple2');
        
        // Show the page
		return View::make('frontend/blog/category', $this->data);
    }
...
//		}
		...
		// Show the page
		return View::make('frontend/blog/view-post', $this->data)->withCookie($postViewId);
    }
